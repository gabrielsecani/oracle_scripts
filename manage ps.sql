...
col name for a40
SELECT NAME, CREATOR, SEQUENCE#, ARCHIVED, APPLIED, DELETED, COMPLETION_TIME FROM V$ARCHIVED_LOG
where COMPLETION_TIME >= trunc(sysdate,'mm')+5
 order by COMPLETION_TIME, SEQUENCE#;
